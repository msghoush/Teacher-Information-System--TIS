...
PROTECTED_ROUTE_RULES = (
    ...
    PermissionRule(r"/planning/curriculum-adjustments", ("GET",), ("curriculum.adjust",), "planning"),
    PermissionRule(r"/planning/curriculum-adjustments/preview", ("POST",), ("planning.edit_section", "curriculum.adjust"), "planning", match="any"),
    PermissionRule(r"/planning/curriculum-adjustments/apply", ("POST",), ("curriculum.adjust",), "planning"),
    ...
    PermissionRule(r"/my-timetable", ("GET",), ("timetable.view",), "timetable"),
    PermissionRule(r"/published-timetable", ("GET",), ("timetable.view",), "timetable"),
    PermissionRule(r"/timetable/api/assign", ("POST",), ("timetable.create", "timetable.edit", "timetable.delete"), "timetable", match="any"),
    PermissionRule(r"/timetable/api/generation-runs", ("POST",), ("timetable.generate",), "timetable"),
    PermissionRule(r"/timetable/api/generation-runs/[^/]+", ("GET",), ("timetable.generate",), "timetable"),
    PermissionRule(r"/timetable/api/generation-runs/[^/]+/cancel", ("POST",), ("timetable.generate",), "timetable"),
    PermissionRule(r"/timetable/api/versions/[^/]+/copy", ("POST",), ("timetable.create",), "timetable"),
    PermissionRule(r"/timetable/api/versions/[^/]+/lock", ("POST",), ("timetable.lock_lessons",), "timetable"),
    PermissionRule(r"/timetable/api/versions/[^/]+/validate", ("POST",), ("timetable.edit",), "timetable"),
    PermissionRule(r"/timetable/api/versions/[^/]+/publish", ("POST",), ("timetable.publish",), "timetable"),
    PermissionRule(r"/timetable/api/versions/[^/]+/archive", ("POST",), ("timetable.archive_versions",), "timetable"),
    PermissionRule(r"/timetable/api/versions/[^/]+/delete-working", ("POST",), ("timetable.delete_working",), "timetable"),
    PermissionRule(r"/timetable/api/versions/compare", ("GET",), ("timetable.view",), "timetable"),
    PermissionRule(r"/timetable/versions/[^/]+/export\.xlsx", ("GET",), ("timetable.export",), "timetable"),
    PermissionRule(r"/timetable/versions/[^/]+/export\.pdf", ("GET",), ("timetable.export",), "timetable"),
