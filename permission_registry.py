...
PERMISSION_GROUPS = (
    ...
    },
    {
        ...
        "label": "Hiring Plan",
        "permissions": (
            ("hiring_plan.view", "View hiring plan"),
            ("hiring_plan.edit", "Create and adjust hiring plan"),
            ("hiring_plan.export", "Export hiring plan"),
        ),
    },
    {
        "key": "reports",
    ...
    },
    {
        ...
        "permissions": (
            ...
            ("timetable.manage_teacher_rules", "Manage teacher scheduling rules"),
            ...
            ("timetable.delete_versions", "Permanently delete unused timetable versions"),
...
_EDITOR_LIKE_PERMISSIONS = {
    ...
    "teachers.manage_capacity",
    "teachers.import",
    "teachers.export",
    "planning.view",
    "planning.create_section",
    "planning.edit_section",
    "planning.assign_teacher",
    "planning.manage_homeroom",
    "timetable.view",
    "timetable.create",
    "timetable.edit",
    "timetable.export",
