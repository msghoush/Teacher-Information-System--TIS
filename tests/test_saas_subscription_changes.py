...
class SaaSSubscriptionChangeTests(unittest.TestCase):
    ...
    def test_subscription_portal_shows_unified_capacity_and_final_actions(self):
        ...
        self.assertIn("Up to 5", response.text)
        self.assertIn("4 of 20", response.text)
        self.assertIn("8 of 100", response.text)
        self.assertNotIn("2 available within Professional", response.text)
    ...
    def test_scheduled_plan_change_can_be_canceled_without_changing_tenant_or_entitlements(self):
        ...
        self.assertIn("Scheduled Plan Change", portal_response.text)
        self.assertIn("Current Plan", portal_response.text)
        self.assertIn("Current plan: Enterprise AI", portal_response.text)
